...
### C.3.1 erste Merkmalsauswahl + Datenaufteilung in Traindaten und Testdaten
```{r}
...
### C.3.3 Überprüfung der Modellannahmen
...
### C.3.5 Überprüfung der Modellannahmen des verbesserten Modells
